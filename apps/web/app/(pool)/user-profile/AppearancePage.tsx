...
import PreferanceSection from './PreferanceSection'
import VehiclesSection from './VehiclesSection'
import Ride from '@/components/Profile/PostedRide'
...
const Appearance = () => {
  ...
  return (
    <div className={cn('flex flex-col justify-between gap-y-4')}>
      <div className='flex flex-col md:flex-row gap-y-4 justify-around md:items-center' >
        <div className='flex gap-x-4 md:justify-center pt-2 md:pt-8 items-center w-[40%]'>
