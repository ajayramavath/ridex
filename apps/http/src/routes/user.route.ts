import { Routes, GetUploadUrlSchema, GetViewUrlSchema, UpdateProfileInfoSchema, UpdateProfilePhotoSchema, AddVehicleSchema, UpdateVehicleSchema, GetUserSchema, UpdateUserPreferenceSchema, removeVehiclePhotoSchema } from "@ridex/common";
...
export class UserRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/update-profile-photo`, AuthMiddleware, ValidationMiddleware(UpdateProfilePhotoSchema), this.user.uploadProfilePhoto);
    ...
    this.router.post(`${this.path}/update-preference`, AuthMiddleware, ValidationMiddleware(UpdateUserPreferenceSchema), this.user.updateUserPreference);
    this.router.post(`${this.path}/remove-vehicle-photo`, AuthMiddleware, ValidationMiddleware(removeVehiclePhotoSchema), this.user.removeVehiclePhoto);
  }
}